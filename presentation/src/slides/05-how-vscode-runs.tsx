  ...
  return (
    <div className="slide" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minHeight: '90vh' }}>
      ...
      <div className="flow" style={{ flex: 1, alignItems: 'stretch', gap: '16px', margin: '1.5em 0' }}>
        <div className="step" style={{ fontSize: '1.2em', padding: '1.35em 1.2em', display: 'flex', flexDirection: 'column', justifyContent: 'center', flex: 1 }}>
      ...
      <div className="callout" style={{ fontSize: '1.08em', maxWidth: '1100px', padding: '1.2em 1.6em 1.2em 3.1em' }}>
